...
const float MAX_SIZE_EXPLODE		= 7.5f;						// スライム4同士の爆発の大きさ
...
// サイズ2
const float LEVEL2_SCALE = 3.0f;					// スライム＿レベル２の大きさ(当たり判定含む)
...
// サイズ4
const float LEVEL4_SCALE = 6.7f;					// スライム＿レベル４の大きさ(当たり判定含む)
