...
const float INTERVAL_INITIAL	= 0.2f;									//繝上Φ繝槭�ｼ蛻晄悄髢馴囈
const float INTERVAL_PLUS		= 3.2f;									//繝上Φ繝槭�ｼ繧剃ｸ蝗樊険繧九→縺阪↓荵礼ｮ励＆繧後ｋ蛟､
const float INTERVAL_MINUS		= 0.97f;								//豈弱ヵ繝ｬ繝ｼ繝繝上Φ繝槭�ｼ繧呈険繧矩俣髫斐ｒ遏ｭ縺上＆縺帙ｋ蛟､
