...
// =============== インクルード ===================
#include "TitleBgGrass.h"	//自身のヘッダ
#include "Defines.h"		//画面情報用

// =============== 定数定義 ===================
const std::string TEXTURE_FILE = "Assets/Texture/Title/Grass.png";	//テクスチャファイル名
const int MAX_ANIM(93);											//アニメーション数
const TDiType<int> MAX_SEAT(5, 19);									//5x19
