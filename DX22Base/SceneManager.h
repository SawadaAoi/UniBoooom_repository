...
private:
	...
	const std::map<size_t, XAUDIO2_BUFFER*> MAP_BGM = {
		{typeid(CTitle).hash_code(), CSound::LoadSound("Assets/Sound/BGM/Title_Select.mp3", true)},			//タイトル
		{typeid(CSelectStage).hash_code(), CSound::LoadSound("Assets/Sound/BGM/Title_Select.mp3", true)},	//ステージ選択
		{typeid(CStage1).hash_code(), CSound::LoadSound("Assets/Sound/BGM/Stage1.mp3", true)},		//ステージ1
		{typeid(CStage2).hash_code(), CSound::LoadSound("Assets/Sound/BGM/Stage2.mp3", true)},		//ステージ2
		{typeid(CStage3).hash_code(), CSound::LoadSound("Assets/Sound/BGM/Stage3.mp3", true)},		//ステージ3
		{typeid(CResult).hash_code(), CSound::LoadSound("Assets/Sound/BGM/Result.mp3", true)},		//リザルト
	};	//BGMデータ
public:
	// ===プロトタイプ宣言===
