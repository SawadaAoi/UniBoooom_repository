...
/* ========================================
	...
	内容：アニメ再生フラグをセット
	-------------------------------------
	引数：アニメ再生判定フラグ（falseなら最後のアニメーション番号に達している）
	-------------------------------------
	戻値：なし
=========================================== */
...
/* ========================================
	...
	戻値：なし
=========================================== */
void CDrawAnim::SetAnimNum(int num)
{
	m_nNumAnim = num;
}
...
/* ========================================
	アニメコマ位置リセット関数
	-------------------------------------
	内容：アニメーション番号をリセット(初期位置に)
	-------------------------------------
	引数：無し
	-------------------------------------
	戻値：なし
=========================================== */
void CDrawAnim::AnimReset()
{
	m_nFrameCnt = 0;	// コマ切り替えカウントをリセット
	m_nNumAnim = 0;		// アニメーション番号をリセット
	m_bAnim = true;
}
