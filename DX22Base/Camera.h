/* ========================================
	...
	・2023/10/24	仮制作
	・2023/11/02	メンバー変数追加
	・2023/11/04	フラグ追加？・private→protected・その他諸々修正
...
public:
	...
	enum E_BIT_FLAG
	{
		E_BIT_FLAG_AS_2D = 0x00,		//2Dのように描画する(フラグが立っていないときは3Dとして描画)
		E_BIT_FLAG_VIBRATION = 0x01,	//画面振動
		E_BIT_FLAG_3,					//
		E_BIT_FLAG_4,					//
		E_BIT_FLAG_5,					//
		E_BIT_FLAG_6,					//
...
public:
	...
	virtual DirectX::XMFLOAT4X4 GetViewMatrix();		//ビュー行列変換
	DirectX::XMFLOAT4X4 GetProjectionMatrix();			//プロジェクション行列変換
};	//カメラ
