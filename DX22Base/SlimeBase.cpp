...
/* ========================================
	...
	内容：火炎ハンマーに殴られたかのフラグ
	----------------------------------------
	引数1：火炎ハンマーに殴られたか(bool)
	----------------------------------------
	戻値：なし
======================================== */
void CSlimeBase::SetPreExplode(bool bExplode)
{
	m_bPreExplode = bExplode;
}
...
/* ========================================
	ハンマーに殴られた状態取得関数
	----------------------------------------
	内容：他スライムと衝突時に爆発するか取得
	----------------------------------------
	引数1：なし
	----------------------------------------
	戻値：ハンマーに殴られた状態(bool)
======================================== */
bool CSlimeBase::GetPreExplode()
{
	return m_bPreExplode;
}
